...
CASES_PATH="${CASES_PATH:-data/laws/processed/rag_law_eval_cases.vat.seed.json}"
EXCLUDE_PATH="${EXCLUDE_PATH:-data/laws/processed/rag_law_eval_cases.vat.holdout.json}"
REPORT_DIR="${REPORT_DIR:-/private/tmp/law-cross-v2}"
FINAL_REPORT="${FINAL_REPORT:-data/processed/rag_eval_reports/law_vat_dev_50_cross_encoder_v2.json}"
