...
# This module is an unmodified retrieval snapshot from commit 6a23c08
# (2026-07-07), stored under ``app.legacy_july7``.  Its data directory must
# remain the live API data directory rather than this package directory.
